...
namespace FoodStore_API.Controllers
{
    ...
    public class EmailController : ControllerBase
    {
        ...
        {
            var message = new Message(new string[] { "n18dccn132@student.ptithcm.edu.vn", "n18dccn222@student.ptithcm.edu.vn" }, subject, content, null);
            if(message == null)
            {
                return BadRequest();
            }
        ...
        public async Task<IActionResult> SendMailWithAttachment()
        {
            ...
            var message = new Message(new string[] { "n18dccn132@student.ptithcm.edu.vn"}, "Gửi tài liệu", "Đây là tài liệu được gửi từ người dùng",files);
            if (message == null)
            {
                return BadRequest();
            }
